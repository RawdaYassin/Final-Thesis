...
\toprule
\textbf{Metric} & \textbf{GraphSAGE} & \textbf{QGNN} & \textbf{Split GNN} & \textbf{SNN (Var.\ III)} & \textbf{VAE-Stacked} \\
\midrule
...
\begin{tabularx}{\textwidth}{lXXXXX}
\toprule
\textbf{Consideration} & \textbf{GraphSAGE} & \textbf{QGNN} & \textbf{Split GNN} & \textbf{SNN} & \textbf{AE-Stacked} \\
\midrule
Training Speed & Fast ($\sim$45 min) & Slow ($\sim$75 min) & Moderate ($\sim$25 min/config) & Moderate ($\sim$60 min) & Fast ($\sim$20 min + 5 min) \\
...
Inference Latency & Low ($<$10 ms) & Moderate ($\sim$15 ms) & Moderate ($\sim$20 ms) & High ($\sim$50 ms) & Low ($<$10 ms) \\
Scalability & Excellent & Limited & Good & Moderate & Excellent \\
...
\begin{tabularx}{\textwidth}{Xrrrrr}
\toprule
\textbf{Statistic} & \textbf{GraphSAGE} & \textbf{QGNN} & \textbf{Split GNN} & \textbf{SNN (Var.\ III)} & \textbf{VAE-Stacked} \\
\midrule
...
\begin{tabularx}{\textwidth}{Xrrrrr}
\toprule
\textbf{Age Group} & \textbf{GraphSAGE} & \textbf{Split GNN} & \textbf{SNN (Var.\ III)} & \textbf{VAE-Stacked} & \textbf{DAE-Stacked} \\
\midrule
...
\begin{tabularx}{\textwidth}{Xrrrrr}
\toprule
\textbf{Employment Status} & \textbf{GraphSAGE} & \textbf{Split GNN} & \textbf{SNN (Var.\ III)} & \textbf{VAE-Stacked} & \textbf{DAE-Stacked} \\
\midrule
